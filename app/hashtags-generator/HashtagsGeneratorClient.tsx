...
import { OpenAIModel, HashtagsGeneratorBody } from '@/types/types';
import {
  Button,
  Flex,
  Text,
...
export default function HashtagsGeneratorClient() {
  ...
  const handleTranslate = async () => {
    ...
    const body: HashtagsGeneratorBody = {
      content,
      model,
      apiKey,
    };

    const response = await fetch('/api/hashtagsGeneratorAPI', {
      method: 'POST',
      ...
      >
        ...
        >
          ...
          <Text fontSize={'16px'} color="gray.500" fontWeight="500" mb="30px">
            Type a few hashtags with # included and separated by a "," (eg.
            #paris, #travel, #coding).
          </Text>
          <Textarea
            border="1px solid"
            ...
            color={textColor}
            placeholder="Type here your hashtags..."

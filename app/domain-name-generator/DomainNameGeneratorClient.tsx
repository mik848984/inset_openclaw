...
export default function DomainNameGeneratorClient() {
  ...
  const handleKeywords = (Event: any) => setKeywords(Event.target.value);
  const handleIndustry = (Event: any) => setIndustry(Event.target.value);

...
import { OpenAIModel, PetNameGeneratorBody } from '@/types/types';
...
export default function PetNameGeneratorClient() {
  ...
  const handleTranslate = async () => {
    ...
    const body: PetNameGeneratorBody = {
      type,
      traits,
      gender,
      model,
  ...
  const handleTraits = (Event: any) => setTraits(Event.target.value);
  const handleGender = (Event: any) => setGender(Event.target.value);

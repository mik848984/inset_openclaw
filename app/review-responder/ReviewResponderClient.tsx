...
import { OpenAIModel, ReviewResponderBody } from '@/types/types';
import {
  Button,
  Flex,
  FormLabel,
...
export default function ReviewResponderClient() {
  ...
  const handleTranslate = async () => {
    ...
    const body: ReviewResponderBody = {
      name,
      review,
      model,
      apiKey,
  ...
  const handleReview = (Event: any) => setReview(Event.target.value);
      ...
      >
        ...
        >
          ...
          <Text fontSize={'16px'} color="gray.500" fontWeight="500" mb="30px">
            What your review response will be about?
          </Text>
          <FormLabel
            display="flex"
            ms="10px"
          ...
          <Input
            ...
            id="name"
            fontWeight="500"
            placeholder="Type here your client name..."
          ...
          <Textarea
            ...
            _focus={{ borderColor: 'none' }}
            color={textColor}
            placeholder="Enter here your review..."
            _placeholder={placeholderColor}
        ...
        <Card maxW="100%" h="100%">
          ...
          <Text fontSize={'16px'} color="gray.500" fontWeight="500" mb="30px">
            Enjoy your response for your review!
          </Text>
          ...
          <Button
            ...
            onClick={() => {
              ...
              toast({
                title: outputCode
                  ? `Response succesfully copied!`
                  : `Generate some review first!`,
                position: 'top',

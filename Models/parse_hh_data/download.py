...
from llm.proxy import get_next_proxy_usa, get_next_proxy_all
...
def download(get_url):
    @wraps(get_url)
    def wrapper(*args, timeout=10, requests_interval=2, max_requests_number=2,
                break_reasons=None):
